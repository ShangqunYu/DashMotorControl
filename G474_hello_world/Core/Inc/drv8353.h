...
#define OCP_ACT_HALF        0x0     /// Associated half-bridge is shutdown in response to VDS_OCP and SEN_OCP
#define OCP_ACT_ALL         0x1     ///All three half-bridges are shutdown in response to VDS_OCP and SEN_OCP
